		...
		(a.jPlayer.prototype = {
			...
			_init: function() {
				...
				if (
					...
					a.each(a.jPlayer.event, function(a, d) {
						c.options[a] !== b &&
							(c.element.bind(d + '.jPlayer', c.options[a]), (c.options[a] = b));
					}),
			...
			destroyRemoved: function() {
				...
				a.each(this.instances, function(a, c) {
					b.element !== c &&
						(c.data('jPlayer') || (c.jPlayer('destroy'), delete b.instances[a]));
				});
			},
			enable: function() {},
			disable: function() {},
			...
			_qualifyURL: function(a) {
				...
				return (
					(b.innerHTML = '<a href="' + this._escapeHtml(a) + '">x</a>'), b.firstChild.href
				);
			},
			...
			_setOption: function(b, c) {
				...
				switch (b) {
					...
					case 'fullWindow':
						this.options[b] !== c &&
							(this._removeUiClass(), (this.options[b] = c), this._refreshSize());
						break;
					case 'size':
						this.options.fullWindow ||
			...
			_html_clearMedia: function() {
				this.htmlElement.media &&
					((this.htmlElement.media.src = 'about:blank'), this.htmlElement.media.load());
			},
			_html_load: function() {
